...
// Brand names, loanwords the language uses as they are (Prompt, App, Audio,
// Endpoint), and words spelled the same (German "Format", French "Services").
const SAME_AS_ENGLISH: Partial<Record<Language, readonly string[]>> = {
  ...
  es: [
    ...
    "menu.elaborationPrompts", "shortcuts.app", "details.prompt", "drawThings.negative", "advanced.prompt",
  ],
  fr: [
