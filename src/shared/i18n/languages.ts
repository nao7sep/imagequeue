// The interface languages ImageQueue ships, in the order the Settings picker
// lists them after System: Latin-script languages alphabetically by their own
// names, then Cyrillic, then CJK. Each tag names a catalogue in ./locales, which
// both processes read: the main process resolves the computer's language and
// the saved choice to one of these tags and draws its own native surfaces from
// the same catalogues, and the renderer takes the language main settled on.
//
...
// What main settles on and hands every window: the interface language and the
